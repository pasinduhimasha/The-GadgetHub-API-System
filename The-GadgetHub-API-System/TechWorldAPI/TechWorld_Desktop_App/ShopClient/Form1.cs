...
namespace TechWorld_Desktop_App
{
    public partial class Form1 : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            item.DeliveryDate = txt_DATE.Text;  // Add DeliveryDate from txt_DATE
        ...
        {
            string url = "https://localhost:7293/api/Product/" + lblID.Text;
            HttpClient client = new HttpClient();
            MyItem item = new MyItem();
            item.Name = txtName.Text;
            item.Price = decimal.Parse(txtPrice.Text);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            string url = "https://localhost:7293/api/Product/" + txtID.Text;
            HttpClient client = new HttpClient();
            var response = client.GetAsync(url).Result;
            if (response.IsSuccessStatusCode)
            {
